...
class BiddingTests {
    ...
    void testListingHasListOfBids() {
        ...
        listing.addToBiddings(new Bidding(bidAmount: 3.50, bidder: bidder))
        listing.addToBiddings(new Bidding(bidAmount: 4.50, bidder: bidder))
        listing.save(flush: true)
        assert 4 == listing.biddings.size()
